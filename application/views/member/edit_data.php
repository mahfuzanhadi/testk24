    ...
    <div class="card my-2">
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="old_image" value="<?= $member['foto']; ?>" />                 
                <div class="form-row">
                    <div class="form-group col-sm-4">
                        <label for="nama">Nama <font color="red">*</font></label>
                        <input class="form-control" type="text" name="nama" id="nama" placeholder="Nama" value="<?= $member['nama']; ?>" />
                        <small class="form-text text-danger"><?= form_error('nama'); ?></small>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="tanggal_lahir">Tanggal Lahir <font color="red">*</font></label>
                        <input class="form-control" type="date" name="tanggal_lahir" id="tanggal_lahir" placeholder="Tanggal Lahir" value="<?= $member['tanggal_lahir']; ?>" />
                ...
                <div class="form-group col-sm-4">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input class="form-control" type="text" name="no_hp" id="no_hp" placeholder="No. HP" value="<?= $member['no_hp']; ?>"  onkeypress="javascript:return isNumber(event)" />
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-sm-4">
                        <label for="no_ktp">No. KTP</label>
                        <input class="form-control" type="text" name="no_ktp" id="no_ktp" placeholder="No. KTP" value="<?= $member['no_ktp']; ?>" onkeypress="javascript:return isNumber(event)" />
                    </div>
                    <div class="form-group col-sm-4">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-4">
                        ...
                        <input class="form-control" type="text" name="email" id="email" placeholder="Email" value="<?= $member['email']; ?>" />
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input type="hidden" value="<?= $member['password'] ?>" name="password2" />
